...
function RegisterDesk(props) {
    ...
    const validationSchema = Yup.object({
        ...
        password2: Yup.string().required().oneOf([Yup.ref("password1")], "Passwords do not match").label('Password')
            ...
            <Form>
                {errors && getErrorElem(errors)}
                    ...
                    <div className='mb-3'>
                        ...
                        <Field name='password1' type='password' className='form-control' placeholder='password'/>
                        <Field name='password2' type='password' className='form-control' placeholder='confirm password'/>
                    </div>
                    <button type="submit" onClick={()=>{console.log(errors)}} className="btn btn-primary">Submit</button>
                </Form>
                )
            }
            </Formik>
